...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    -It is a library created by facebook with the intent of making UI design much easier

- [ ] What does it mean to _think_ in react?
    its the box thinking idea we discussed in lecture.  
    
    - You think of components and their children and how they would stack together to make the UI you are desiring


- [ ] Describe state.

  - state is something we create for data that is going to change in a component.  If we want to change it, we just setState() to do so

- [ ] Describe props.

  - props are the parameters that you can pass around to different components to make them flexible to new data that you create
